...
object AnalyticsEvents {
    object Screens {
        ...
        const val EDIT_LIFT = "screen_edit_lift"
        ...
        const val WORKOUT_CALENDAR = "screen_workout_calendar"
        const val GOALS = "screen_goals"
        const val TIMER = "screen_timer"
        const val CALCULATOR = "screen_calculator"
        ...
        const val WRAPPED_REPS = "screen_wrapped_reps"
        const val WRAPPED_PROGRESS = "screen_wrapped_progress"
        const val WRAPPED_GOALS = "screen_wrapped_goals"
        const val WRAPPED_SUMMARY = "screen_wrapped_summary"
