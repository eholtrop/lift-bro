...
import lift_bro.core.generated.resources.variation_text_field_favourite_content_description
import lift_bro.core.generated.resources.variation_text_field_select_lift_text
            ...
            leadingIcon = if (variation.favourite) {
                {
                    Icon(
                        ...
                        contentDescription = stringResource(Res.string.variation_text_field_favourite_content_description),
                    )
                }
            } else {
                null
            ...
            if (onLiftChanged != null) {
                ...
                Button(
                    ...
                    if (liftName?.isNotBlank() == true) {
                        ...
                        Text(
                            text = stringResource(Res.string.variation_text_field_select_lift_text)
                        )
                    }
                }
                DropdownMenu(
