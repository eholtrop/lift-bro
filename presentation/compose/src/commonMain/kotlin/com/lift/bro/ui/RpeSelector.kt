...
import lift_bro.core.generated.resources.rpe_selector_fallback_text
...
fun RpeSelector(
    ...
    Row(
        ...
        Column(
            ...
            Text(
                text = RPE.entries.firstOrNull { it.rpe == rpe }?.emoji ?: stringResource(Res.string.rpe_selector_fallback_text),
