...
import lift_bro.core.generated.resources.settings_experimental_features_text
import lift_bro.core.generated.resources.settings_experimental_title_text
import lift_bro.core.generated.resources.settings_lift_pros_title
...
import lift_bro.core.generated.resources.settings_timer_title
    ...
    LiftingScaffold(
        ...
        content = { padding ->
            ...
            LazyColumn(
                    ...
                    when (subscriptionType) {
                        SubscriptionType.None -> {
                            SettingsRowItem(
                                ...
                                Text(stringResource(Res.string.settings_experimental_features_text))
                            }
                        }
                ...
                item {
                    SettingsRowItem(
                        title = { Text(stringResource(Res.string.settings_experimental_title_text)) }
                    ) {
                        Column {
                            ...
                            if (subscriptionType == SubscriptionType.Pro && localServer != null) {
                                SettingsRowItem(
                                    ...
                                    title = { Text(stringResource(Res.string.settings_lift_pros_title)) }
                                ) {
