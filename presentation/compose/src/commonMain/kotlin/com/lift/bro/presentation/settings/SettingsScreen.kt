                        ...
                        SettingsRowItem(
                            title = {
                                Row(
                                    ...
                                    var enabled by remember { mutableStateOf(dependencies.settingsRepository.enableTimer()) }
                                    Checkbox(
                                        checked = enabled,
                                        onCheckedChange = {
                                            enabled = !enabled
                            ...
                            Text("Enable a set timer/recorder for counting you down as well as record video of a given set")
                        }
                    }
                }
