...
import lift_bro.core.generated.resources.settings_experimental_features_title
import lift_bro.core.generated.resources.settings_experimental_goodies_text
...
import lift_bro.core.generated.resources.settings_pro_server_title
    ...
    LiftingScaffold(
        ...
        content = { padding ->
            ...
            LazyColumn(
                    ...
                    when (subscriptionType) {
                        SubscriptionType.None -> {
                            SettingsRowItem(
                                ...
                                Text(stringResource(Res.string.settings_experimental_goodies_text))
                            }
                        }
                ...
                item {
                    SettingsRowItem(
                        title = { Text(stringResource(Res.string.settings_experimental_features_title)) }
                    ) {
                        Column {
                            ...
                            if (subscriptionType == SubscriptionType.Pro && localServer != null) {
                                SettingsRowItem(
                                    ...
                                    title = { Text(stringResource(Res.string.settings_pro_server_title)) }
                                ) {
