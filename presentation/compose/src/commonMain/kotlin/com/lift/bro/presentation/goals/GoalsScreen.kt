...
import lift_bro.core.generated.resources.goals_screen_achieved_content_description
import lift_bro.core.generated.resources.goals_screen_delete_content_description
import lift_bro.core.generated.resources.goals_screen_goals_title
...
fun GoalsScreen(
    ...
    LiftingScaffold(
        title = {
            Text(stringResource(Res.string.goals_screen_title, "2026"))
        },
    ) { padding ->
            ...
            stickyHeader {
                Button(
                    ...
                    Row(
                        ...
                        Text(
                            stringResource(Res.string.goals_screen_goals_title),
                    ...
                    IconButton(
                        ...
                        if (item.achieved) {
                            Icon(
                                ...
                                contentDescription = stringResource(Res.string.goals_screen_achieved_content_description)
                            )
                        } else {
                            Icon(
                    ...
                    IconButton(
                        ...
                        Icon(
                            imageVector = Icons.Default.Delete,
                                contentDescription = stringResource(Res.string.goals_screen_delete_content_description)
                        )
                    }
                }
            }
