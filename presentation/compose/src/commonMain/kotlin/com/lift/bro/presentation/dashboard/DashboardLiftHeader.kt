...
import lift_bro.core.generated.resources.dashboard_lift_header_add_category_content_description
        ...
        Row(
            ...
            IconButton(
                ...
                Icon(
                    ...
                    contentDescription = stringResource(Res.string.dashboard_lift_header_add_category_content_description)
                )
            }
        }
        Row(
            ...
            ChipButton(
                ...
                Text(
                    text = stringResource(Res.string.dashboard_lift_header_rpe_chip_text),
                    color = if (showRpe) {
                        MaterialTheme.colorScheme.onPrimary
                    } else {
                        TextFieldDefaults.colors().disabledTextColor
            ...
            if (showTempo != null) {
                ChipButton(
                    ...
                    Text(
                        text = stringResource(Res.string.dashboard_lift_header_tempo_chip_text),
                        color = if (showTempo) {
                            MaterialTheme.colorScheme.onPrimary
                        } else {
                            TextFieldDefaults.colors().disabledTextColor
