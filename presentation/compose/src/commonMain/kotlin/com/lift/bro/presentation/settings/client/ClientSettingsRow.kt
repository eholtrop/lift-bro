...
import lift_bro.core.generated.resources.client_settings_local_mode_text
import lift_bro.core.generated.resources.client_settings_remote_mode_text
            ...
            Row(
                ...
                Box {
                    Button(
                        ...
                        Text(
                            when (state.mode) {
                                ClientMode.Local -> stringResource(Res.string.client_settings_local_mode_text)
                                is ClientMode.Remote -> stringResource(Res.string.client_settings_remote_mode_text)
                            },
