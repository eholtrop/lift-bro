...
import lift_bro.core.generated.resources.onboarding_setup_variation_comma_separator
            ...
            item {
                Row(
                    ...
                    RadioButtonCard(
                        ...
                        Text(
                            stringResource(Res.string.onboarding_setup_lbs),
                            style = MaterialTheme.typography.displayLarge
                        )
                    }
                    ...
                    RadioButtonCard(
                        ...
                        Text(
                            stringResource(Res.string.onboarding_setup_kg),
                            style = MaterialTheme.typography.displayLarge
                        )
                    }
                    Space(MaterialTheme.spacing.two)
                            ...
                            Row {
                                liftVariations?.forEachIndexed { index, variation ->
                                    ...
                                    val separator = stringResource(
                                        Res.string.onboarding_setup_variation_comma_separator
                                    )
                                    val variationText = if (index == variations.size - 1) {
                                        variation.name ?: ""
                                    } else {
