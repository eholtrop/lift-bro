...
import lift_bro.core.generated.resources.info_dialog_info_content_description
import lift_bro.core.generated.resources.info_dialog_ok_cta
...
fun InfoDialogButton(
    ...
    IconButton(
        ...
        Icon(
            ...
            contentDescription = stringResource(Res.string.info_dialog_info_content_description),
            tint = buttonTint,
        )
    }
}
        ...
        Row {
            ...
            onConfirmClicked?.let {
                ...
                Button(
                    ...
                    Text(
                        text = stringResource(Res.string.info_dialog_ok_cta),
