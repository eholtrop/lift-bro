...
import lift_bro.core.generated.resources.info_speech_bubble_always_do_something
import lift_bro.core.generated.resources.info_speech_bubble_confirm_cta
import lift_bro.core.generated.resources.info_speech_bubble_informational_message
import lift_bro.core.generated.resources.info_speech_bubble_multiple_lines_message
import lift_bro.core.generated.resources.info_speech_bubble_pro_tip
import lift_bro.core.generated.resources.info_speech_bubble_warm_up_message
    ...
    PreviewAppTheme(isDarkMode = darkMode) {
        Column(
            ...
            InfoSpeechBubble(
                ...
                message = {
                    Column {
                        Text(stringResource(Res.string.info_speech_bubble_informational_message))
                        Space(MaterialTheme.spacing.half)
                        Text(stringResource(Res.string.info_speech_bubble_multiple_lines_message))
                    }
                },
                forceDarkIcon = false,
                onConfirmClicked = {},
            ...
            InfoSpeechBubble(
                ...
                message = { Text(stringResource(Res.string.info_speech_bubble_warm_up_message)) },
                forceDarkIcon = true,
                onConfirmClicked = {},
            )
            ...
            InfoSpeechBubble(
                title = { Text(stringResource(Res.string.info_speech_bubble_pro_tip)) },
                message = { Text(stringResource(Res.string.info_speech_bubble_always_do_something)) },
                forceDarkIcon = true,
                onConfirmClicked = {},
            )
        }
