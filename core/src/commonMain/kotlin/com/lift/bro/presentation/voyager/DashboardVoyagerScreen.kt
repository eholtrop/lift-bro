...
import com.lift.bro.presentation.lift.LiftListScreen
import com.lift.bro.presentation.lift.LiftListVoyagerScreen
...
class DashboardVoyagerScreen(): Screen {
    ...
    override fun Content() {
        ...
        DashboardScreen(
            ...
            seeAllClicked = { navigator.push(LiftListVoyagerScreen())}
        )
    }
}